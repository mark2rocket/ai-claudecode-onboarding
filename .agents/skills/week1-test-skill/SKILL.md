---
name: week1-test-skill
description: Week 1 테스트 스킬. "/week1-test-skill" 입력 시 실행된다. Skill이 어떻게 동작하는지 직접 체험하는 용도.
---
...
> **방금 일어난 일:**
> 1. `/week1-test-skill` 입력 → Claude가 `.claude/skills/week1-test-skill/SKILL.md` 파일을 찾아 읽음
