# Session 5: 자막 + 음성으로 완성 릴스 — "SRT + TTS + FFmpeg = 완성본"
...
Session 3: GIF 배경 + 텍스트 오버레이 (소스: GIF)
Session 4: 영상 소스 + FFmpeg 합성 (소스: 촬영)
Session 5: SRT 자막 + TTS 음성 + 최종 합성 (완성본)
...
□ 자막이 영상 위에 잘 보이나?
□ 오디오와 자막 타이밍이 맞나?
□ Session 2부터 비교했을 때 발전 과정이 느껴지나?
```
...
Session 2~5에서 완성한 것:
┌──────────────────────────────────────────┐
│  Session 2: HTML 애니메이션 릴스           │
│  Session 3: GIF 배경 + 텍스트 오버레이    │
│  Session 4: 영상 소스 + FFmpeg 합성        │
│  Session 5: SRT 자막 + TTS 음성 완성본    │
└──────────────────────────────────────────┘
...
Session 9에서 이 파이프라인을 템플릿으로 만든다.
Track 2(Remotion)도 경험해보고 싶다면 Session 6으로.
```
