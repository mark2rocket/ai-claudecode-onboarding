...
> 💡 **용어 정리**
> - **Plugin(기능 묶음 패키지)**: 여러 기능을 하나로 묶어 한 줄 명령으로 설치할 수 있게 만든 것. 스마트폰 앱과 비슷하지만, Claude의 여러 기능(Skill·MCP·Hook 등)을 한 번에 묶은 것
> - **패키징/배포**: 내가 만든 기능을 다른 사람들도 쓸 수 있게 포장해서 공유하는 것
...
> **clarify(명확화 도구)**: "이번 달 인스타 전략 짜줘" 같은 모호한 요청을 Claude가 알아서 질문하며 구체화해주는 플러그인
