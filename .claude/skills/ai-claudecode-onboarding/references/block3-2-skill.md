...
> 점진적 로딩 [쉬운 말: 필요할 때만 꺼내 읽기] — Claude의 대화 기억 용량(컨텍스트 윈도우)은 한정되어 있습니다. Skill은 호출할 때만 불러오기 때문에 메모리를 아낄 수 있습니다.

> 컨텍스트 윈도우 [쉬운 말: 대화 기억 용량] — Claude가 한 번에 기억할 수 있는 대화의 양. 이게 가득 차면 앞의 내용을 잊기 시작합니다.
